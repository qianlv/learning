...
/* This implementation uses the strategy of splitting all at once when the any
   field is requested. */
...
static int  is_split = 0;     /* has this line been split? */
...
static void reset(void)
{
	...
	sline = NULL;
	field = NULL;
	maxline = maxfield = nfield = is_split = 0;
}
