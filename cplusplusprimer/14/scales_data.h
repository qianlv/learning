...
class Scales_data 
{
    ...
    friend Scales_data operator+ (const Scales_data&, const Scales_data&);
    friend std::istream& operator>> (std::istream &is, Scales_data &item);
    friend std::ostream& operator<< (std::ostream &os, const Scales_data &item);
...
public:
    ...
    Scales_data(const Scales_data&);

    ~Scales_data();

    Scales_data& operator= (const Scales_data &rhs);
    Scales_data& operator+= (const Scales_data&);
    operator std::string() const { return bookNo; }
    operator double() const { return avg_price(); }
...
Scales_data operator+ (const Scales_data&, const Scales_data&);
std::istream& operator>> (std::istream &is, Scales_data &item);
std::ostream& operator<< (std::ostream &os, const Scales_data &item);
